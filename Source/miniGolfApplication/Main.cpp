...
#include "miniGolfApplicationPCH.h"
...
//VIMPORT IVisPlugin_cl* GetEnginePlugin_miniGolfPlugin();
VIMPORT IVisPlugin_cl* GetEnginePlugin_VisionEnginePlugin();
VIMPORT IVisPlugin_cl* GetEnginePlugin_vHavok();

class miniGolfApplicationClass : public VAppImpl
{
public:
  miniGolfApplicationClass() {}
  virtual ~miniGolfApplicationClass() {}
...
VAPP_IMPLEMENT_SAMPLE(miniGolfApplicationClass);

void miniGolfApplicationClass::SetupAppConfig(VisAppConfig_cl& config)
{
...
void miniGolfApplicationClass::PreloadPlugins()
{
  ...
  //VISION_PLUGIN_ENSURE_LOADED(miniGolfPlugin);
...
//---------------------------------------------------------------------------------------------------------
void miniGolfApplicationClass::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool miniGolfApplicationClass::Run()
{
  return true;
}

void miniGolfApplicationClass::DeInit()
{
  // De-Initialization
  // [...]
}
