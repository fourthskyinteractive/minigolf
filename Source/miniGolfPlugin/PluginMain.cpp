...
//============================================================================================================
class miniGolfPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "miniGolfPlugin";  // must match DLL name
  }
};

//  global plugin instance
miniGolfPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_miniGolfPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_miniGolfPlugin();}
...
void miniGolfPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("miniGolfPluginClass:OnInitEnginePlugin()");
...
void miniGolfPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("miniGolfPluginClass:OnDeInitEnginePlugin()");
